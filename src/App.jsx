    ...
    return (
      <div className="app desktop-app" style={{ '--user-accent': accentColor }}>
        <nav className="desktop-side-nav">
          <div className="dsn-glass" style={{ '--active': tab === 'chats' ? 0 : tab === 'contacts' ? 1 : tab === 'music' ? 2 : 3 }}>
            <div className="dsn-indicator" />
            {[
              { id: 'chats', label: 'Чаты', icon: (
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M21 11.5a8.38 8.38 0 01-.9 3.8 8.5 8.5 0 01-7.6 4.7 8.38 8.38 0 01-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 01-.9-3.8 8.5 8.5 0 014.7-7.6 8.38 8.38 0 013.8-.9h.5a8.48 8.48 0 018 8v.5z" /></svg>
              ) },
              { id: 'contacts', label: 'Контакты', icon: (
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75"/></svg>
              ) },
              { id: 'music', label: 'Музыка', icon: (
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M9 18V5l12-2v13"/><circle cx="6" cy="18" r="3"/><circle cx="18" cy="16" r="3"/></svg>
              ) },
              ...
              <button
                key={id}
                className={`dsn-tab ${tab === id ? 'dsn-tab-active' : ''}`}
                onClick={() => setTab(id)}
              >
                {icon}
                <span>{label}</span>
